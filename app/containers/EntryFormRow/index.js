    ...
    return (
      <tr className={styles.entryFormRow}>
        <td>
          ...
          >
            <div id="categId" className={styles.formSection}>
              <Field component={DataSelector} name="categoryId" data={categories} />
            </div>
            <div className={styles.formSection}>
              <Field id="descriptionId" component="input" name="description" type="text" placeholder="Description" />
            </div>
            <div className={styles.formSection}>
              <Field id="valueId"
                component="input"
              ...
              />
              <button id="addButtonId" type="submit" disabled={!isValid}>
                Add
              </button>
            </div>
          </Form>
